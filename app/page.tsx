...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen relative overflow-x-hidden">
      {/* More Blurred Gradient Blobs for both sides */}
      <div className="pointer-events-none select-none z-0">
        {/* Top left */}
        <div className="absolute top-[-120px] left-[-120px] w-[340px] h-[340px] bg-gradient-to-br from-purple-400 via-primary to-blue-400 opacity-30 rounded-full blur-3xl" />
        {/* Bottom right */}
        <div className="absolute bottom-[-120px] right-[-120px] w-[340px] h-[340px] bg-gradient-to-tr from-green-300 via-blue-400 to-purple-300 opacity-20 rounded-full blur-3xl" />
        {/* Mid left */}
        <div className="absolute top-1/3 left-[-100px] w-[220px] h-[220px] bg-gradient-to-br from-primary via-purple-400 to-blue-300 opacity-20 rounded-full blur-2xl" />
        {/* Mid right */}
        <div className="absolute top-1/2 right-[-100px] w-[220px] h-[220px] bg-gradient-to-tr from-blue-400 via-green-300 to-purple-300 opacity-20 rounded-full blur-2xl" />
        {/* Lower left */}
        <div className="absolute bottom-32 left-[-80px] w-[180px] h-[180px] bg-gradient-to-br from-green-300 via-primary to-blue-400 opacity-15 rounded-full blur-2xl" />
        {/* Lower right */}
        <div className="absolute bottom-24 right-[-80px] w-[180px] h-[180px] bg-gradient-to-tr from-purple-400 via-blue-400 to-green-300 opacity-15 rounded-full blur-2xl" />
        {/* Center faint scissors watermark */}
        <svg className="absolute left-1/2 top-[40%] -translate-x-1/2 -translate-y-1/2 w-[420px] h-[420px] opacity-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g>
            <path d="M12 12L36 36" stroke="#6e27b6" strokeWidth="4" strokeLinecap="round"/>
            <path d="M36 12L12 36" stroke="#6e27b6" strokeWidth="4" strokeLinecap="round"/>
            <circle cx="12" cy="12" r="4" stroke="#6e27b6" strokeWidth="2" fill="none"/>
            <circle cx="36" cy="36" r="4" stroke="#6e27b6" strokeWidth="2" fill="none"/>
          </g>
        </svg>
      </div>
